...
import { featureBanners, lifestyleImages, LOGO_NFC_URL } from '@/data/products';
  ...
  return (
    <div className="py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Brand Showcase */}
        <div className="relative rounded-2xl overflow-hidden mb-20 bg-gradient-to-r from-[hsl(220,25%,6%)] to-[hsl(220,25%,10%)] border border-white/5 p-8 sm:p-12">
          <div className="flex flex-col lg:flex-row items-center gap-10">
            <div className="flex-shrink-0">
              <img src={LOGO_NFC_URL} alt="AxonRing NFC" className="w-56 h-56 object-contain drop-shadow-2xl" />
            </div>
            <div>
              ...
              <p className="text-gray-300 leading-relaxed">
                ...
                until you tap it to pay, unlock, or connect.
              </p>
            </div>
          </div>
        </div>
